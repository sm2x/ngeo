...
function PopoverController($scope) {
  ...
  angular__WEBPACK_IMPORTED_MODULE_0___default.a.element('body').on('mousedown', onMouseDown.bind(this));
  $scope.$on('$destroy', function () {
    angular__WEBPACK_IMPORTED_MODULE_0___default.a.element('body').off('mousedown', onMouseDown);
  });
}
