...
/* harmony import */ var ol_color_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ol/color.js */ "./node_modules/ol/color.js");
/* harmony import */ var ol_format_Feature_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ol/format/Feature.js */ "./node_modules/ol/format/Feature.js");
/* harmony import */ var ol_format_TextFeature_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ol/format/TextFeature.js */ "./node_modules/ol/format/TextFeature.js");
/* harmony import */ var ol_geom_GeometryLayout_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ol/geom/GeometryLayout.js */ "./node_modules/ol/geom/GeometryLayout.js");
/* harmony import */ var ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ol/geom/LineString.js */ "./node_modules/ol/geom/LineString.js");
/* harmony import */ var ol_geom_MultiLineString_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ol/geom/MultiLineString.js */ "./node_modules/ol/geom/MultiLineString.js");
...
/* harmony import */ var ol_geom_MultiPolygon_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ol/geom/MultiPolygon.js */ "./node_modules/ol/geom/MultiPolygon.js");
...
/* harmony import */ var ol_style_Text_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ol/style/Text.js */ "./node_modules/ol/style/Text.js");
...
function FeatureHash(opt_options) {
  ol_format_TextFeature_js__WEBPACK_IMPORTED_MODULE_7__["default"].call(this);
  ...
  this.propertiesFunction_ = options.properties !== undefined ? options.properties : defaultPropertiesFunction_;
...
Object(ol_util_js__WEBPACK_IMPORTED_MODULE_3__["inherits"])(FeatureHash, ol_format_TextFeature_js__WEBPACK_IMPORTED_MODULE_7__["default"]);
var StyleTypes_ = {
...
function encodeStylePoint_(imageStyle, encodedStyles) {
  if (imageStyle instanceof ol_style_Circle_js__WEBPACK_IMPORTED_MODULE_15__["default"]) {
...
function encodeStyleFill_(fillStyle, encodedStyles, opt_propertyName) {
  ...
  if (fillColor !== null) {
    ...
    var fillColorRgba = ol_color_js__WEBPACK_IMPORTED_MODULE_5__["asArray"](fillColor);
...
function encodeStyleStroke_(strokeStyle, encodedStyles) {
  ...
  if (strokeColor !== null) {
    ...
    var strokeColorRgba = ol_color_js__WEBPACK_IMPORTED_MODULE_5__["asArray"](strokeColor);
...
function readLineStringGeometry_(text) {
  ...
  return new ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_9__["default"](flatCoordinates, ol_geom_GeometryLayout_js__WEBPACK_IMPORTED_MODULE_8__["default"].XY);
}
...
function readMultiLineStringGeometry_(text) {
  ...
  return new ol_geom_MultiLineString_js__WEBPACK_IMPORTED_MODULE_10__["default"](flatCoordinates, ol_geom_GeometryLayout_js__WEBPACK_IMPORTED_MODULE_8__["default"].XY, ends);
}
...
function readPointGeometry_(text) {
  ...
  return new ol_geom_Point_js__WEBPACK_IMPORTED_MODULE_13__["default"](flatCoordinates, ol_geom_GeometryLayout_js__WEBPACK_IMPORTED_MODULE_8__["default"].XY);
}
...
function readMultiPointGeometry_(text) {
  ...
  text = text.substring(2, text.length - 1);
  var flatCoordinates = this.decodeCoordinates_(text);
  return new ol_geom_MultiPoint_js__WEBPACK_IMPORTED_MODULE_11__["default"](flatCoordinates, ol_geom_GeometryLayout_js__WEBPACK_IMPORTED_MODULE_8__["default"].XY);
}
...
function readPolygonGeometry_(text) {
  ...
  return new ol_geom_Polygon_js__WEBPACK_IMPORTED_MODULE_14__["default"](flatCoordinates, ol_geom_GeometryLayout_js__WEBPACK_IMPORTED_MODULE_8__["default"].XY, ends);
}
...
function readMultiPolygonGeometry_(text) {
  ...
  return new ol_geom_MultiPolygon_js__WEBPACK_IMPORTED_MODULE_12__["default"](flatCoordinates, ol_geom_GeometryLayout_js__WEBPACK_IMPORTED_MODULE_8__["default"].XY, endss);
}
...
function setStyleInFeature_(text, feature) {
  ...
  if (fillColor !== undefined) {
    fillStyle = new ol_style_Fill_js__WEBPACK_IMPORTED_MODULE_16__["default"]({
      color: fillColor
    });
  }
  ...
  if (strokeColor !== undefined && strokeWidth !== undefined) {
    strokeStyle = new ol_style_Stroke_js__WEBPACK_IMPORTED_MODULE_17__["default"]({
      color: strokeColor,
      width: strokeWidth
    });
  }
  ...
  if (pointRadius !== undefined) {
    imageStyle = new ol_style_Circle_js__WEBPACK_IMPORTED_MODULE_15__["default"]({
      radius: pointRadius,
      fill: fillStyle,
      stroke: strokeStyle
    });
  ...
  if (fontSize !== undefined && fontColor !== undefined) {
    textStyle = new ol_style_Text_js__WEBPACK_IMPORTED_MODULE_19__["default"]({
  ...
  var style = new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_18__["default"]({
    fill: fillStyle,
    image: imageStyle,
    stroke: strokeStyle,
    text: textStyle
...
function setStyleProperties_(text, feature) {
  ...
  if (geometry instanceof ol_geom_Point_js__WEBPACK_IMPORTED_MODULE_13__["default"]) {
    ...
    if (geometry instanceof ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_9__["default"]) {
      delete properties['fillColor'];
...
function writeLineStringGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_LineString_js__WEBPACK_IMPORTED_MODULE_9__["default"]);
...
function writeMultiLineStringGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_MultiLineString_js__WEBPACK_IMPORTED_MODULE_10__["default"]);
...
function writePointGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_Point_js__WEBPACK_IMPORTED_MODULE_13__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
  var end = flatCoordinates.length;
...
function writeMultiPointGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_MultiPoint_js__WEBPACK_IMPORTED_MODULE_11__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
  var end = flatCoordinates.length;
  return "P(" + this.encodeCoordinates_(flatCoordinates, stride, 0, end) + ")";
...
function writePolygonGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_Polygon_js__WEBPACK_IMPORTED_MODULE_14__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
  var ends = geometry.getEnds();
  var offset = 0;
...
function writeMultiPolygonGeometry_(geometry) {
  console.assert(geometry instanceof ol_geom_MultiPolygon_js__WEBPACK_IMPORTED_MODULE_12__["default"]);
  var flatCoordinates = geometry.getFlatCoordinates();
  var stride = geometry.getStride();
...
FeatureHash.prototype.writeGeometryText = function (geometry, opt_options) {
  ...
  var transformedGeometry = ol_format_Feature_js__WEBPACK_IMPORTED_MODULE_6__["transformWithOptions"](geometry, true, opt_options);
