...
MainController.prototype.inMap = function () {
  this.inMapMsgs_.forEach(function (message) {
    this.disclaimer.alert({
      ...
      type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_4__["default"].Type.WARNING
    });
  }, this);
};
...
MainController.prototype.closeAll = function () {
  this.disclaimer.close({
    ...
    type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_4__["default"].Type.SUCCESS
  });
  this.disclaimer.close({
    msg: this.infoMsg_,
    type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_4__["default"].Type.INFORMATION
  });
  this.disclaimer.close({
  ...
  this.disclaimer.close({
    msg: this.errorMsg_,
    type: ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_4__["default"].Type.ERROR
  });
  this.inMapMsgs_.forEach(function (message) {
    this.disclaimer.close({
      msg: message,
...
Object(ol_util_js__WEBPACK_IMPORTED_MODULE_4__["inherits"])(Disclaimer, ngeo_message_Message_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
